...
export function ExamAlert({ schools }: Props) {
  ...
  return (
    <section className="rounded-[28px] bg-[#171519] p-4 text-white shadow-soft">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-warm text-text">
            🗓️
          </div>
        ...
        <label className="flex items-center gap-2.5 self-start rounded-full border border-white/10 bg-white/5 px-3.5 py-1.5 text-sm text-white/90">
      ...
      <div className="mt-5 space-y-4">
        <div className="rounded-[24px] bg-white/5 p-4">
          ...
          <div className="mt-6">
            ...
            <div className="mt-3.5 h-2.5 rounded-full bg-white/10">
              <div
        ...
        <div className="rounded-[24px] bg-white/5 p-3.5">
